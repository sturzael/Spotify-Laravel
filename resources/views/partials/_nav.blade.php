...
<div class="top-banner">
  <div class="inner-container-top-banner">
    <div class="wrapper-banner">
      <ul class="left">
  <li><a class="account-link" tabindex="2" href="{{ route('home') }}"><i class="fa fa-user a-icon"></i><span class="a-text">Home </span></a></li>
      </ul>
      <ul class="right">
          @guest
      ...
      @else
          <li><a class="account-link" tabindex="2" href="/blog/1/edit"><i class="fa fa-user a-icon"></i><span class="a-text">Control Panel </span></a></li>
          <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" aria-haspopup="true">
                  {{ Auth::user()->name }} <span class="caret"></span>
              </a>
