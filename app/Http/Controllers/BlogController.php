...
class BlogController extends Controller {
    ...
    public function store(Request $request) {
        $this->validate($request, ['header' => 'required |min:2|max:40', 'para_one_header' => 'required|min:3|max:20', 'para_one_sub_header_1' => 'required|min:3|max:20', 'para_one_text_1' => 'required|min:3', 'para_one_sub_header_2' => 'required|min:3|max:40', 'para_one_text_2' => 'required|min:3', 'para_one_sub_header_3' => 'required|min:3|max:40', 'para_one_text_3' => 'required|min:3', 'para_two_header' => 'required|min:3|max:40', 'para_two_sub_header_1' => 'required|min:3|max:40', 'para_two_text_1' => 'required|min:3', 'para_two_sub_header_2' => 'required|min:3|max:40', 'para_two_text_2' => 'required|min:3', 'para_two_sub_header_3' => 'required|min:3|max:40', 'para_two_text_3' => 'required|min:3', 'footer_small_text' => 'required|min:5|max:100', 'footer_big_text' => 'required|min:5|max:100']);
        $id = $request->id;
        // die($id);
